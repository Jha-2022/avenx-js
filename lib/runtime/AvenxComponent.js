...
export class AvenxComponent {
    ...
    /**
     * A map of computed property expressions.
    ...
    constructor(initialState = {}, computed = {}, bridges = {}, template = '', methods = {}) {
         ...
         * Computed properties are evaluated on access.
         * @type {Proxy}
         */
        this.state = new Proxy(initialState, {
            ...
            get(target, key) {
                if (computed[key]) {
                    ...
                    const context = { ...target, ...self.#bridges };
                    try {
                        const fn = new Function(...Object.keys(context), `with(this) { return ${expr} }`);
                        return fn.call(self.state, ...Object.values(context));
                    } catch (e) {
                        console.warn("Avenx Computed Error:", e, "Expression:", expr, "Component State:", target);
                        return undefined;
                    }
                }
                return target[key];
